...
// vault's in-process embedder (apps/server/src/lib/embedder.ts: slice 8000, 2048-token cap, mean pooling, normalized)
...
fx.tokenizer.model_max_length = 2048; // EMBED_MAX_TOKENS
const vectors = [];
