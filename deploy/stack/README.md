...
`tests/isolation.sh` (118 checks) logs in through the real Authentik flow (`tests/login.sh`) and verifies:
...
`tests/metamcp-attacks.sh` (95 checks, all through Traefik with the provisioned keys):
