// EUrouter routing rules ("routes"). A vault's LLM calls pass the chosen rule as `rule_id` on
// POST /api/v1/chat/completions; the route brings its models, no `model` is needed
// (docs: eurouter.ai/docs/api/routing-rules, /docs/api/chat).
