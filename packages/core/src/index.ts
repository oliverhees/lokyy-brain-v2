...
export { EurouterHttpError, EUROUTER_HOST, EUROUTER_RULE_NOT_FOUND, isEurouterBaseUrl, isEurouterRuleId, eurouterRulesUrl, listEurouterRules } from './adapters/eurouter';
