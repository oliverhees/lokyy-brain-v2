...
- LBV2-32: sources ingested via `/api/ingest/text` (and other `/api/ingest/*` routes) are listed by `/api/tree/raw` under their raw id with title and open in the raw source view (before: "Failed to load").
